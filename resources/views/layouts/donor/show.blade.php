...
<head>
    ...
    <style>
        .float-button {
            ...
            background-color: #0D6EFD; /* Bootstrap danger (red) color */
            color: white;
            border-radius: 10px; /* Rounded corners */
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); /* Shadow */
            text-align: center;
            line-height: 50px; /* Adjusted to match the button's height */
        ...
        .float-button:hover {
            background-color: #238bc8; /* Darker red on hover */
        }
    </style>
</head>
...
<body>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-center">
                                            @if($student->images)
                                                <img src="{{ asset('student_images/' . $student->images) }}" alt="{{ $student->name_of_student }}" 
                                                     class="img-fluid rounded-circle border border-primary" 
                                                     style="width: 200px; height: 200px;">
                                            @else
                                                <img src="{{ asset('student_images/abc/dummy.png') }}" alt="Default Photo" 
                                        ...
                                        <!-- Student Info -->
                                        <div class="col-md-8">
                                            <h6 class="card-text"><strong>Registration No:</strong> {{ $student->qalam_id }}</h6>
                                            <h6 class="card-text"><strong>Student Name:</strong> {{ $student->name_of_student }}</h6>
                                            <h6 class="card-text"><strong>Institution:</strong> {{ $student->institutions }}</h6>
                                            <h6 class="card-text"><strong>City:</strong> {{ $student->city }}</h6>
                                            <h6 class="card-text"><strong>Father/Guardian Profession:</strong> {{ $student->father_profession }}</h6>
                                            <h6 class="card-text"><strong>Intake Year:</strong> {{ $student->year_of_admission }}</h6>
                                            <h6 class="card-text"><strong>Intake Year:</strong> {{ $student->student_status }}</h6>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5 mb-3" >
                                        ...
                                        <canvas id="cgpaChart{{ $student->id }}" style="width: 100%; height: 250px; border: 2px solid rgb(2, 121, 233)"></canvas>
                                    </div>
                                    <div class="col-md-6" >
                                        <h4 class="text-dark mt-5 text-center">Thank You Note</h4>
                                        <p>
                                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ducimus in deserunt cum itaque doloribus deleniti eius eligendi tenetur, vero optio natus ipsam autem voluptas, at accusamus atque delectus maxime sit.
                                        </p>
                                    </div>
    ...
    <div class="container mt-5 p-3">
        ...
        <div class="row">
            <!-- Left side (Image) -->
            <div class="col-md-4 text-center">
                <img src="{{ asset('student_images/abc/Arooba_Gillani.png') }}" alt="Thank You" 
                    class="img-fluid" 
            ...
            <div class="col-md-8 position-relative mt-5">
                ...
                <p class="mt-3">
                    We would like to extend our heartfelt gratitude to all our donors for their generous contributions.
                    Your support has enabled countless students to pursue their education and fulfill their dreams.
                    Your donations not only impact their academic journey but also make a lasting difference in their lives.
                    Thank you for being a part of this mission and helping us make a difference.
                </p>
                ...
                <div class="position-absolute" style="bottom: auto; right: 10px;">
                    ...
                    <small class="text-muted">Director UAO</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="float-button">
        ...
        <form action="{{ url('logout') }}" method="POST" style="display: inline;">
            @csrf
            <button type="submit" style="background: none; border: none; color: white; font-size: 20px; cursor: pointer;">
                Logout
            </button>
        </form>
    </div>
