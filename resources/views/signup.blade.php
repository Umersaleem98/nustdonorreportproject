...
<!--   Core JS Files   -->
<script src="{{ asset('dashbaord/assets/js/core/popper.min.js') }}"></script>
<script src="{{ asset('dashbaord/assets/js/core/bootstrap.min.js') }}"></script>
<script src="{{ asset('dashbaord/assets/js/plugins/perfect-scrollbar.min.js') }}"></script>
<script src="{{ asset('dashbaord/assets/js/plugins/smooth-scrollbar.min.js') }}"></script>
<script>
...
<script src="{{ asset('dashbaord/assets/js/argon-dashboard.min.js?v=2.0.4') }}"></script>
